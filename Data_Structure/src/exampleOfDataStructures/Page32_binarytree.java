...
public class Page32_binarytree {
	private Node start;
	public Page32_binarytree() {start=null;}	//creator
	
	public class Node{	
		private char name; //node configuration
		private Node left, right;
		public Node(char newIsland, Node lt, Node rt) {name = newIsland; left = lt; right=rt;}
	}
	
	public Node map() {	//create map
	...
	public static void main(String[] args) {
		...
		Page32_binarytree travel = new Page32_binarytree(); //instance
